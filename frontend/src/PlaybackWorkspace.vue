...
<style scoped>
.playback-workspace{min-width:0;max-width:1840px;margin:0 auto;padding:12px 18px 26px;box-sizing:border-box}.playback-main-grid{display:grid;grid-template-columns:minmax(210px,240px) minmax(0,1fr) minmax(380px,460px);gap:10px;align-items:stretch}.playback-sidebar{min-width:0;overflow:hidden;display:flex;flex-direction:column;border:1px solid var(--nvr-border);border-radius:10px;background:var(--nvr-surface)}.playback-sidebar-section{padding:12px}.playback-sidebar-label{margin-bottom:8px;color:var(--nvr-muted);font-size:9px;font-weight:700;letter-spacing:.06em}.playback-date-picker{width:100%!important}.playback-sidebar-divider{height:1px;flex:none;background:var(--nvr-border)}.playback-camera-head{display:flex;align-items:center;justify-content:space-between;padding:11px 12px 7px}.playback-camera-head strong{font-size:10px}.playback-camera-head span{min-width:20px;padding:2px 6px;border-radius:999px;color:var(--nvr-subtle);background:var(--nvr-bg-soft);font-size:8px;text-align:center}.playback-camera-list{min-height:0;overflow:auto;padding:0 7px 9px;scrollbar-gutter:stable}.playback-camera-row{position:relative;width:100%;display:flex;align-items:center;gap:9px;padding:8px 9px;border:1px solid transparent;border-radius:7px;color:var(--nvr-muted);background:transparent;font:inherit;text-align:left;cursor:pointer}.playback-camera-row:hover{background:var(--nvr-bg-soft);color:var(--nvr-text-soft)}.playback-camera-row.active{border-color:color-mix(in srgb,var(--nvr-blue) 44%,var(--nvr-border));color:var(--nvr-text);background:color-mix(in srgb,var(--nvr-blue) 10%,var(--nvr-bg-soft))}.playback-camera-row.active::before{content:'';position:absolute;left:-1px;top:7px;bottom:7px;width:2px;border-radius:2px;background:var(--nvr-blue)}.camera-status-dot{width:7px;height:7px;flex:none;border-radius:50%;background:#667386;box-shadow:0 0 0 3px rgba(102,115,134,.09)}.camera-status-dot.online{background:#38b66f;box-shadow:0 0 0 3px rgba(56,182,111,.11)}.camera-status-dot.offline{background:#d15858;box-shadow:0 0 0 3px rgba(209,88,88,.1)}.camera-name{min-width:0;overflow:hidden;font-size:10px;text-overflow:ellipsis;white-space:nowrap}.playback-video-panel{min-width:0;align-self:start;padding:10px;border:1px solid var(--nvr-border);border-radius:10px;background:var(--nvr-surface)}.playback-video-meta{min-height:34px;display:flex;align-items:flex-start;justify-content:space-between;gap:10px;padding:0 2px}.playback-video-title{min-width:0;display:flex;align-items:baseline;gap:8px}.playback-video-title strong{flex:none;font-size:11px}.playback-video-title span{min-width:0;overflow:hidden;color:var(--nvr-subtle);font-size:8px;text-overflow:ellipsis;white-space:nowrap}.playback-video-actions{flex:none;display:flex;align-items:center;gap:8px}.playback-clock{color:var(--nvr-text-soft);font-size:12px;font-variant-numeric:tabular-nums;letter-spacing:.03em}.playback-workspace :deep(.playback-v3){margin-top:10px;border:1px solid var(--nvr-border);border-radius:10px;background:var(--nvr-surface)}.playback-workspace :deep(.playback-event-feed){min-width:0;height:100%}
@media(min-width:1101px){.playback-workspace{height:calc(100vh - 131px);height:calc(100dvh - 131px);display:grid;grid-template-rows:minmax(0,1fr) auto;overflow:hidden;padding:10px 18px 12px}.playback-main-grid{min-height:0;overflow:hidden}.playback-sidebar{min-height:0}.playback-camera-list{flex:1}.playback-workspace :deep(.playback-player .player-box){width:100%;aspect-ratio:16/9}.playback-workspace :deep(.playback-event-feed){min-height:0;display:flex;flex-direction:column}.playback-workspace :deep(.playback-event-feed .event-feed-body){max-height:none;min-height:0;flex:1}.playback-workspace :deep(.playback-v3){margin-top:8px}}
