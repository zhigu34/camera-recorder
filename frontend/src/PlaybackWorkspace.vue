...
@media(min-width:1101px){.playback-workspace{height:calc(100vh - 131px);height:calc(100dvh - 131px);display:grid;grid-template-rows:minmax(0,1fr) auto;overflow:hidden;padding:10px 18px 12px}.playback-main-grid{min-height:0;overflow:hidden;align-self:start}.playback-left-slot>.playback-sidebar{position:absolute;inset:0}.playback-sidebar{min-height:0}.playback-camera-list{flex:1}.playback-workspace :deep(.playback-player .player-box){width:100%;aspect-ratio:16/9}.playback-events-slot :deep(.playback-event-feed){position:absolute;inset:0;min-height:0;display:flex;flex-direction:column}.playback-workspace :deep(.playback-event-feed .event-feed-body){max-height:none;min-height:0;flex:1}.playback-workspace :deep(.playback-v3){margin-top:8px}}
