...
.event-filter-row{display:flex;gap:5px;padding:8px 10px;border-bottom:1px solid var(--nvr-border);background:color-mix(in srgb,var(--nvr-hover) 48%,transparent)}
...
@media (max-width:1220px){.event-card{grid-template-columns:118px minmax(0,1fr) 10px}.event-feed-body{max-height:310px}}
