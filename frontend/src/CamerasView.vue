...
<template>
  <section class="camera-page" v-loading="loading">
    ...
    <el-drawer v-model="drawerVisible" size="540px" class="camera-detail-drawer" @closed="closeDrawer">
      <template #header>
