...
const playheadStyle = computed(() => ({ left: `calc(60px + (100% - 60px) * ${playheadRatio.value})` }))
...
@media (max-width:900px){.playback-v3{padding-inline:8px}.timeline-ruler,.timeline-overview,.overview-caption{margin-left:48px}.timeline-lane-row{grid-template-columns:48px 1fr}.playback-v3-zoom button{padding-inline:8px}}
</style>
