...
<style scoped>
.playback-v3{--timeline-label-width:60px;border-top:1px solid var(--nvr-border);padding:14px 14px 10px;background:var(--nvr-surface);user-select:none}.playback-v3-toolbar{display:flex;align-items:center;justify-content:space-between;gap:16px;margin-bottom:8px}.playback-v3-date{display:flex;align-items:baseline;gap:12px;color:var(--nvr-text)}.playback-v3-date strong{font-size:14px}.playback-v3-date span{font-variant-numeric:tabular-nums;font-size:12px;color:var(--nvr-muted)}.playback-v3-zoom{display:flex;padding:2px;border:1px solid var(--nvr-border);border-radius:7px;background:var(--nvr-input)}.playback-v3-zoom button{border:0;background:transparent;color:var(--nvr-muted);font:inherit;font-size:12px;padding:5px 11px;border-radius:5px;cursor:pointer}.playback-v3-zoom button.active{background:var(--nvr-blue);color:#fff}.playback-v3-stage{position:relative}.timeline-ruler{position:relative;height:24px;margin-left:var(--timeline-label-width);border-bottom:1px solid var(--nvr-border)}.timeline-ruler span{position:absolute;top:5px;transform:translateX(-50%);font-size:10px;color:var(--nvr-subtle);font-variant-numeric:tabular-nums;white-space:nowrap}.timeline-lanes{position:relative}.timeline-lane-row{display:grid;grid-template-columns:var(--timeline-label-width) 1fr;min-height:28px;border-bottom:1px solid var(--nvr-border)}.lane-label{display:flex;align-items:center;padding-left:6px;font-size:11px;color:var(--nvr-muted)}.lane-track{position:relative;margin:6px 0;background:var(--nvr-bg-soft);overflow:hidden}.recording-block,.motion-block{position:absolute;top:0;bottom:0;border-radius:2px}.recording-block{background:linear-gradient(90deg,color-mix(in srgb,var(--nvr-blue) 82%,transparent),color-mix(in srgb,var(--nvr-blue) 58%,transparent))}.motion-block{background:var(--nvr-blue);box-shadow:0 0 0 1px var(--nvr-border-strong) inset}.disabled-row .lane-track{background:transparent}.lane-status{position:absolute;left:8px;top:50%;transform:translateY(-50%);font-size:10px;color:var(--nvr-subtle)}.timeline-track-overlay{position:absolute;z-index:4;left:var(--timeline-label-width);right:0;top:0;bottom:0;cursor:crosshair;touch-action:none}.timeline-track-overlay.dragging{cursor:grabbing}.timeline-playhead{position:absolute;z-index:5;top:0;bottom:0;width:1px;background:var(--nvr-blue);box-shadow:0 0 0 1px color-mix(in srgb,var(--nvr-blue) 35%,transparent);pointer-events:none}.timeline-playhead span{position:absolute;top:-28px;left:50%;transform:translateX(-50%);padding:3px 6px;border-radius:4px;background:var(--nvr-blue);color:#fff;font-size:10px;font-weight:700;font-variant-numeric:tabular-nums;white-space:nowrap}.timeline-overview{position:relative;height:18px;margin:10px 0 0 var(--timeline-label-width);border:1px solid var(--nvr-border);border-radius:4px;background:var(--nvr-bg-soft);overflow:hidden;cursor:pointer}.overview-recording{position:absolute;top:3px;bottom:3px;background:color-mix(in srgb,var(--nvr-muted) 46%,transparent)}.overview-window{position:absolute;top:0;bottom:0;border:1px solid var(--nvr-blue);background:color-mix(in srgb,var(--nvr-blue) 12%,transparent);box-sizing:border-box}.overview-caption{display:flex;justify-content:space-between;margin:5px 2px 0 var(--timeline-label-width);font-size:10px;color:var(--nvr-subtle)}
